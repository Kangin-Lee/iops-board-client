...
import { getCookie, getCookieExpirationTime, removeCookie } from "../cookie/ReactCookie";
...
const Navbar = () => {
  ...
  useEffect(()=>{
    // 쿠키가 생성된 시간을 가져옴
    const cookieCreationTime = cookies.userLoginInfo ? new Date(cookies.userLoginInfo) : new Date();
    console.log("cookieCreationTime",cookies.userLoginInfo)
